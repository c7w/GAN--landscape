...
class CNNDiscriminator(nn.Module):
    ...
    def __init__(self, in_channels=3):
        ...
        self.disc_img = nn.Sequential(
            discriminator_block(3, 64, normalization=False),  # Input channels in set to 6 = 3 + 3
        ...
        self.disc_img_with_label = nn.Sequential(
            discriminator_block(3 + 64, 64, normalization=False),  # Input channels in set to 6 = 3 + 3
            *discriminator_block(64, 128),
            *discriminator_block(128, 256),
            *discriminator_block(256, 512, stride=1),
            nn.Conv(512, 1, 4, padding=1, bias=False),
